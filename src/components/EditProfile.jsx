...
const EditProfile = () => {
  ...
  const checkifprofileExists = async () => {
    try {
      const response = await axios.get(`${apiUrl}/check-publickey`, {
        params: {
        ...
        <div className="bg-gray-800 shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
          ...
          <form onSubmit={submitCode}>
            ...
            <div>
              ...
              <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Please </span> Make sure to add a valid image URL.</p>
            </div>
            <div>
              {publicKey ? (
                <button
